...
\begin{itemize}
  ...
  \item \href{https://github.com/tombell/legend}{Legend} an API service and web overlay for OBS. Displaying the currently playing track in Rekordbox
  \item \href{https://github.com/tombell/ensong}{Ensong} a deamon that watches a directory for a WAV file. Converts that file to AIFF (to backup) and MP3 (uploaded to Mixcloud)
...
\paragraph{I also like to play \href{https://magic.wizards.com/en}{Magic: the Gathering} for fun, and have played at a competitive level.}
